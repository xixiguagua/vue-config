  ...
  function generateLoaders (loader, loaderOptions) {
    ...
    if (loader) {
      loaders.push({
        ...
        options: Object.assign({}, loaderOptions, { //Object.assign将loaderOptions和sourceMap组成一个对象
    ...
    if (options.extract) {
      return ExtractTextPlugin.extract({ //分离js文件中引入的css文件
...
exports.styleLoaders = function (options) {
  var output = [] //定义返回的数组，数组中保存的是针对各种类型文件的处理方式
